  ...
  try {
    ...
    const response = await fetch("https://payments.yoco.com/api/checkouts", {
      ...
      body: JSON.stringify({
        ...
        currency: "ZAR",
        successUrl: `${process.env.NEXT_PUBLIC_APP_URL || request.nextUrl.origin}/checkout/success?order_id=${orderId}&checkout_id={{CHECKOUT_ID}}`,
        cancelUrl: `${process.env.NEXT_PUBLIC_APP_URL || request.nextUrl.origin}/checkout?cancelled=true`,
        metadata: {
          order_id: orderId,
