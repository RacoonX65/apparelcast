...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Use Next.js router instead of full page reload for better state management
        ...
        <div className="w-full max-w-sm">
          ...
          <Card className="border-[#E8D5D0]">
            <CardHeader>
              ...
              <CardDescription className="text-[#666]">Enter your email to login to your account</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleLogin}>
                  ...
                  <div className="grid gap-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        ...
                        className="text-sm text-[#666] hover:text-[#FADADD] underline underline-offset-4"
                      >
                        Forgot password?
                      </Link>
                    </div>
                ...
                <div className="mt-4 text-center text-sm text-[#666]">
                  ...
                  <Link
                    href="/auth/sign-up"
                    className="text-[#1a1a1a] underline underline-offset-4 hover:text-[#FADADD]"
                  >
                    Sign up
                  </Link>
                </div>
